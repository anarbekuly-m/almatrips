...
const en = {
  ...
  'gt.bookNote': 'Message us on WhatsApp to check available dates and reserve your seat.',
  'gt.datesRequest': 'Departure dates on request — message us on WhatsApp for the current schedule.',
  'gt.from': 'from',
  ...
  'hero.title': 'Discover the best of Kazakhstan',
  'hero.sub':
...
const ru: typeof en = {
  ...
  'gt.bookNote': 'Напишите нам в WhatsApp, чтобы узнать доступные даты и забронировать место.',
  'gt.datesRequest': 'Даты выездов — по запросу. Напишите нам в WhatsApp, подскажем актуальное расписание.',
  'gt.from': 'от',
  ...
  'hero.title': 'Откройте лучшее в Казахстане',
  'hero.sub':
